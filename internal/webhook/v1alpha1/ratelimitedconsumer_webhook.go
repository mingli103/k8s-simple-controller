...
// +kubebuilder:webhook:path=/validate-ratelimit-itbl-sre-co-v1alpha1-ratelimitedconsumer,mutating=false,failurePolicy=fail,sideEffects=None,groups=ratelimit.test.annotation.com,resources=ratelimitedconsumers,verbs=create;update,versions=v1alpha1,name=vratelimitedconsumer-v1alpha1.kb.io,admissionReviewVersions=v1
...
func validateRateLimitConsumer(ratelimitedconsumer *ratelimitv1alpha1.RateLimitedConsumer) error {
	...
	if len(allErrs) > 0 {
		return errors.NewInvalid(schema.GroupKind{
			Group: "ratelimit.test.annotation.com", Kind: "RateLimitedConsumer"},
